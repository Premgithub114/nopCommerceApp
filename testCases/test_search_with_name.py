...
class test_searching_customer(unittest.TestCase):
    ...
    def test_search_cust(self):
        ...
        self.search_cus_name = search_elements(self.driver)
        self.search_cus_name.enter_FN("Arthur ")
        time.sleep(2)
        self.search_cus_name.enter_LN("Holmes")
        time.sleep(2)
        self.search_cus_name.search_button()
        time.sleep(5)
        status = self.search_cus_name.search_by_name("Arthur Holmes")
        assert status
